    ...
    <AnimatePresence>
      {showFilterModal && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[110] flex items-end sm:items-center sm:justify-center"
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div
                      className={`w-12 h-6 rounded-full relative transition-all duration-300 ${
                        showAvailableOnly ? "bg-white/30" : "bg-gray-300/50"
                      }`}
                    >
                      <motion.div
                        animate={{
                        ...
                        className={`absolute top-0.5 left-0.5 w-5 h-5 rounded-full ${
                          showAvailableOnly ? "bg-white" : "bg-white"
                        } shadow-md`}
                      />
                    </div>
                  </div>
